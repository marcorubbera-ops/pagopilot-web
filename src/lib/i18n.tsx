...
const it = {
  ...
  "docs.category.all": "Tutte le categorie",
  ...
  "detail.attach.success": "Ricevuta allegata",
  "detail.attach.view": "Visualizza ricevuta",
  "detail.attach.viewFailed": "Impossibile aprire la ricevuta",
  ...
  "field.noticeNumber": "Codice Avviso",
  "field.taxCode": "Codice Fiscale Ente Creditore",
  "field.iban": "IBAN",
  "field.tags": "Tag",
  "field.notes": "Note",
  "field.none": "—",
  ...
  "pay.title": "Paga ora",
  "pay.hint":
    "Ti portiamo sul sito ufficiale pagoPA: copia il codice avviso e il codice fiscale dell'ente qui sotto e incollali nel modulo.",
  "pay.checkout": "Paga {amount} su pagoPA",
  "pay.io": "Apri l'app IO",
  "pay.copy": "Copia",
  "pay.copied": "Codice avviso copiato: {code}",
  "pay.copiedTaxCode": "Codice fiscale copiato: {code}",
  "pay.now": "Paga",
...
const en: Record<TranslationKey, string> = {
  ...
  "docs.category.all": "All categories",
  ...
  "detail.attach.success": "Receipt attached",
  "detail.attach.view": "View receipt",
  "detail.attach.viewFailed": "Couldn't open the receipt",
  ...
  "field.noticeNumber": "Notice code",
  "field.taxCode": "Payee tax code",
  "field.iban": "IBAN",
  "field.tags": "Tags",
  "field.notes": "Notes",
  "field.none": "—",
  ...
  "pay.title": "Pay now",
  "pay.hint":
    "We open the official pagoPA site: copy the notice code and the entity's tax code below and paste them into the form.",
  "pay.checkout": "Pay {amount} on pagoPA",
  "pay.io": "Open the IO app",
  "pay.copy": "Copy",
  "pay.copied": "Notice code copied: {code}",
  "pay.copiedTaxCode": "Tax code copied: {code}",
  "pay.now": "Pay",
