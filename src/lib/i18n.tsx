...
const it = {
  ...
  "landing.hero":
    "Bollette, avvisi e tasse in un unico posto tranquillo — con promemoria prima che sia troppo tardi.",
  "landing.cta.primary": "Inizia gratis",
  "landing.cta.secondary": "Ho già un account",
  "landing.feature.import.title": "Importa ed estrai",
  "landing.feature.import.copy": "Fotografa una bolletta: i dati principali si compilano da soli.",
  ...
  "landing.feature.privacy.title": "Privato per default",
  "landing.feature.privacy.copy": "I tuoi documenti restano tuoi, protetti e solo tuoi.",
  ...
  "auth.confirm": "Controlla la tua email per confermare l'account.",
  ...
  "stats.subtitle": "Come stanno andando i tuoi pagamenti",
  "stats.total": "Totale speso",
  "stats.openTotal": "Ancora da pagare",
  "stats.count": "Documenti",
  "stats.avg": "Media per pagamento",
  ...
  "stats.premium.copy": "Con Premium vedi l'andamento per categoria e mese, e l'export dei dati.",
  ...
  "settings.reminders.copy": "Avvisi in-app a 7, 3 e 1 giorno prima di ogni scadenza.",
  "settings.data": "I tuoi dati",
  "settings.export": "Esporta pagamenti (CSV)",
  "settings.about": "Informazioni",
  "settings.about.copy": "PagoPilot organizza i tuoi pagamenti. I pagamenti veri si effettuano sempre tramite la tua banca o l'app IO.",
  ...
  "settings.lock.copy": "Chiedi Face ID o Touch ID ogni volta che apri l'app.",
